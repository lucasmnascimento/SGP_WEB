...
public class ClienteDAO implements ICliente<Cliente, String> {
	...
	public void adicionar(Cliente cliente, Connection con) throws Exception {
		...
		pStmt.setInt(1, cliente.getId_cliente());
                ...
                pStmt.setString(3, cliente.getNomefantasia());
                pStmt.setString(4, cliente.getClassificacaoabc());
                pStmt.setString(5, cliente.getCategoria());
                pStmt.setString(6, cliente.getAmbientevendas());
		pStmt.setString(7, cliente.getCanalvendas());
                pStmt.setString(8, cliente.getLogo());
                pStmt.setString(9, cliente.getRazaosocial());
                pStmt.setInt(10, cliente.getQuantidadedelojas());
                pStmt.setString(11, cliente.getLogradouro());
	...
	public List<Cliente> procurar(String nome, Connection con) throws Exception {
		...
		String sql = "SELECT id_cliente, idrepresentante, nomefantasia, classificacaoabc, categoria, canalvendas, razaosocial, quantidadedelojas, logradouro, numero, complemento, bairro, cidade, estado, cep, outrasinformacoes, status FROM Cliente WHERE UPPER(idcliente) LIKE ?";
