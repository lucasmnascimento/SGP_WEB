...
CREATE UNIQUE INDEX uniq_eventorepresentante ON eventorepresentante (ideventorepresentante, idevento, idrepresentante);

CREATE UNIQUE INDEX uniq_itembalanco ON itembalanco (iditembalanco, idbalanco, idproduto);

CREATE UNIQUE INDEX uniq_quadroswot ON quadroswot (idquadroswot, idcliente);

CREATE UNIQUE INDEX uniq_cliente ON cliente (idcliente, idrepresentante);
